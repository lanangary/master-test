            ...
            $(window).on('orientationchange.fb resize.fb', function(e) {
                requestAFrame(function() {
                    if (
                        e &&
                        e.originalEvent &&
                        e.originalEvent.type == 'orientationchange'
                    ) {
...
(function(window, document, $) {
    ...
    Guestures.prototype.ontouchstart = function(e) {
        ...
        if (
            ...
            (isScrollable($target) && !$target.hasClass('fancybox-slide'))
        ) {
            return;
        }
    ...
    Guestures.prototype.limitPosition = function(
        ...
        if (newWidth > canvasWidth) {
            ...
            newOffsetX =
                newOffsetX < canvasWidth - newWidth ? canvasWidth - newWidth : newOffsetX;
        } else {
            // Center horizontally
